...
@router.patch("/")
async def change_supplier_permission(db: Annotated[AsyncSession, Depends(get_db)],
    ...
    if get_user.get('is_admin'):
        ...
        if user.is_supplier:
            ...
            return {
                ...
                "detail": "User permission changed to customer"
            }
        else:
            ...
            return {
                "status_code": status.HTTP_200_OK,
                "detail": "User permission changed to supplier"
            }
    else:
